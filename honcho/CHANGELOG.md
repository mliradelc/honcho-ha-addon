...
## [3.0.44] - 2026-06-10
### Fixed
- Hard error in run.sh on missing dialectic OVERRIDES to catch misconfiguration early and emit an AuthenticationError instead of silent silent failures or 401s
