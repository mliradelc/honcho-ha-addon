# Auto-generated credentials.py file with mistral transport fallback fix
...
def default_transport_api_key(transport: str) -> str | None:
    ...
    if transport == "mistral":
        return settings.LLM.OPENAI_API_KEY if settings.LLM.OPENAI_API_KEY else settings.LLM.MISTRAL_API_KEY
